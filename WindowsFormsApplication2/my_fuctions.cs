...
namespace WindowsFormsApplication2
{
    class my_fuctions
    {
        ...
        public static int[] Godel_Num1(int Input)
        {
            if (Input < 2)
                return new int[1] { 0 };
        ...
        public static Double Godel_Num2(Double[] Input)
        {
            Double Ans = 1;
            int k = 0;
        ...
        private static int GetFactor(int Input1, int Input2)
        {
            int Ans = 0;
        ...
        public static int[] Pairing2(int Input) //overload
        {
            int[] Ans = new int[2];
            Input++;
            Ans[0] = GetFactor(Input, 2);
            if (Ans[0] > 0)
                Input /= Power(2, Ans[0]);
            Input--;
            Ans[1] = Input / 2;
        ...
        public static int[] Pairing3(int Input)  //overload
        {
            int[] Ans = new int[3];
        ...
        public static string GetLable2(int Input)
        {
            if (Input < 0) System.Windows.Forms.MessageBox.Show("Lable Error");
            if (Input == 0)
                return "";
        ...
        public static string GetCode2(int Lable, int Instraction, int Variable)
        {
            ...
            if (Instraction == 0)
                ...
                return GetLable(Lable) + "if " + GetVariable2(Variable) + "!= 0 go to " + GetLable2(Instraction - 2);
        }
        ...
        public static string GetCode(int Lable, int Instraction, int Variable)
        {
            ...
            if (Instraction == 0)
                ...
                return GetLable(Lable) + GetLable(Variable) + "if " + GetVariable(Variable) + "!= 0 go to " + GetLable2(Instraction - 2);
        }
        public static string GetParings(int Input)
        {
            Input++;
            string Ans = "";
            int[] GN = Godel_Num1(Input);
